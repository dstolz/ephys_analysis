function [e, k, r] = pickEvents(iv, ref, origin, after)
%pickEvents  Apply an event reference to one set of intervals.
%   [E, K, R] = pickEvents(IV, REF, ORIGIN, AFTER) keeps the [on off]
...
%   the edges at or after AFTER (default -Inf) are ranked by time and
%   REF.which / REF.n picks among them. E are the picked times plus
