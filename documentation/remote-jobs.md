...
| [`runSpikeInterface`](EphysDataset.md) + [`pollKSRuns`](../pipeline/@EphysPreprocessingApp/pollKSRuns.m) — detached launch, [`ks4_status.json`](file-formats.md#ks4_statusjson), log tail by byte offset | the status-file and log-offset convention, copied verbatim |
