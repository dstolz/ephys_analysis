...
lbl = uilabel(g, "Text", "Output root:", "Tooltip", ...
    "Per-dataset outputs (kilosort4/, *_extract.mat, *_spikes.mat, exports) go under <root>/<Name>. Blank = next to each recording.");
...
obj.BehStatusLabel.Layout.Row = 2; obj.BehStatusLabel.Layout.Column = [2 5];
