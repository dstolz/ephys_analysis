...
obj.ConvLabelFieldDropDown = uidropdown(cg, ...
    "Items", {'custom_channel_name', 'native_channel_name'}, "Value", 'custom_channel_name', ...
    "Tooltip", "labelField: channel name field used for info.labels and the digital-event names.", ...
    "ValueChangedFcn", changed);
...
obj.ConvTargetsTable = uitable(rg, "ColumnName", {'Dataset', 'Output file', 'Status', 'Note'}, ...
    "ColumnWidth", {130, '1x', 170, 170}, "RowName", {});
