...
D = table(obj.NasTicked(:), T.Status, leafName(T.IntanDir), timeText(T.IntanTime), durationText(T.IntanDuration), ...
...
if n == 0
    ...
    obj.NasSummaryLabel.Text = sprintf("%d paired, %d stitched, %d Intan only, %d ePsych only, %d ambiguous; %d ticked.", ...
