...
check(count(per, "<div class=""n k-src") == 4 && contains(per, "Downstream (reads step outputs)") ...
    ...
    'Layout "Tree per step": a tree from the recording for each of the 4 steps, sorted units and Export downstream; saved as a preference');
